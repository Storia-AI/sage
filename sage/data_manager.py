...
class GitHubRepoManager(DataManager):
    ...
    def walk(self, get_content: bool = True, get_code_symbols: bool = False) -> Generator[Tuple[Any, Dict], None, None]:
        ...
        Args:
            ...
            get_code_symbols: When set to True, includes code symbols in the metadata, under the "code_symbols" key.
        """
        ...
        for root, _, files in os.walk(self.local_path):
            ...
            for file_path in included_file_paths:
                ...
                if get_code_symbols:
                    metadata["code_symbols"] = self._get_code_symbols(relative_file_path)
    ...
    def _get_code_symbols(self, file_path: str) -> List[Tuple[str, str]]:
        ...
        classes_and_methods = []
        self._extract_classes_and_methods(tree.root_node, classes_and_methods)
        ...
        if node.type in ["class_definition", "class_declaration"]:
            ...
            if class_name_node:
                ...
                for child in node.children:
                    GitHubRepoManager._extract_classes_and_methods(child, acc, class_name)
            ...
            for child in node.children:
                GitHubRepoManager._extract_classes_and_methods(child, acc, parent_class)
